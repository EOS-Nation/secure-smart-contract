...
gantt
    ...
    Unit Testing                        :after docs1, 70h
    User Testing                        :after docs1, 50h

    section Flash Loan Template (BR08,BR09)
    Protocol design                     :protocol2, after dev1, 10h
